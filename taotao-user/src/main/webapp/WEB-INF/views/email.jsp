...
<link type="text/css" rel="stylesheet"
	href="http://misc.360buyimg.com/user/myjd-2015/css/myjd.safe.css"
	source="combo" />
<link type="text/css" rel="stylesheet"
...
<script charset="utf-8" type="text/javascript"
	src="/misc/js/validate/validate_mobile.js?t=20121101"></script>
<script type="text/javascript"
...
<body myjd="_MYJD_safe" menuId="set">
			...
			<div class="logo">
					...
					<div class="dl" clstag="click|keycount|myhome|hsz">
						...
						<div class="dd">
							<a tid="_MYJD_info" clstag="Homeyser"
								href="http://i.jd.com/user/info" target="_self"><span></span></a>
							<a tid="_MYJD_safe" clstag="Homesafe"
								href="http://safe.jd.com/user/paymentpassword/safetyCenter.action"
								target="_self"><span></span></a> <a tid="_MYJD_accbinde"
								clstag="Homezhbd" href="http://safe.jd.com/union/index.action"
								target="_self"><span></span></a> <a tid="_MYJD_grade"
								clstag="Homegrade" href="http://usergrade.jd.com/user/grade"
								target="_self"><span></span></a> <a tid="_MYJD_comments"
								clstag="homeadd"
								href="http://easybuy.jd.com/address/getEasyBuyList.action"
								target="_self"><span></span></a> <a tid="_MYJD_share"
								clstag="Homeshare" href="http://share.jd.com/share/index.html"
								target="_self"><span></span></a> <a tid="_MYJD_rss"
								clstag="Homeedm"
								href="http://edm.jd.com/front/subscribe/index.aspx"
								target="_self"><span></span></a> <a tid="_MYJD_recor"
								clstag="Homeedm" href="http://usergrade.jd.com/user/consume"
								target="_self"><span></span></a> <a tid="_MYJD_app"
								clstag="Homeedm" href="http://fw.jd.com/home/auth_list.action"
								target="_blank"><span></span></a> <a tid="_MYJD_pay"
								clstag="Homequick"
								href="https://authpay.jd.com/card/queryBindCard.action"
								target="_blank"><span></span></a> <a tid="_MYJD_zpzz"
								clstag="Homezpzz"
				...
				<li class="fore-4">
					<div class="dl myjd-info" clstag="click|keycount|myhome|hsq">
						...
						<div class="dd">
							<a tid="_MYJD_me" clstag="hgr" href="http://me.jd.com"
								target="_blank"><span></span></a> <a tid="_MYJD_activities"
								clstag="Homeclub"
								href="http://luck.jd.com/myjd/myJoinActivity.html"
								target="_self"><span></span></a> <a tid="_MYJD_circle"
								clstag="Homejoincircle"
								href="http://group.jd.com/circle/myjoincircle.htm"
								target="_self"><span></span></a> <a tid="_MYJD_mycollect"
								clstag="Homethread"
								href="http://group.jd.com/thread/mythread.htm" target="_self"><span></span></a>
						</div>
					</div>
				</li>
				<li class="fore-5"><a tid="_MYJD_joy"
					href="http://joycenter.jd.com" target="_self"
					clstag="homepage|keycount|home2013|Homemsg"></a></li>
				</ul>
			</div>
			<div class="nav-r">
				<div id="search-2014">
					...
					<div class="form">
						<input type="text"
							...
							autocomplete="off" id="key" accesskey="s" class="text" /> <i></i>
						</button>
					</div>
				</div>
	...
	<script type="text/javascript">
		...
		function email() {
			$.ajax({
				...
				type : "get",
				dataType : 'text',
				url : "http://userinfo.taotao.com/email.html",
				data : {
		...
		function identifyCode(){
			...
			type:"get",
			dataType:'text',
			url:"http://userinfo.taotao.com/email/identifyCode.html",
			data : {
	...
	<div id="container">
					...
					<div id="menu">
						<dl class="fore1">
							...
							<dd class="fore1_3" id="_MYJD_accbinde">
								<a clstag="homepage|keycount|home2013|Homezhbd"
									href="http://safe.jd.com/union/index.action" target="_self"></a>
							</dd>
							<dd class="fore1_4" id="_MYJD_grade">
								<a clstag="homepage|keycount|home2013|Homegrade"
									href="http://usergrade.jd.com/user/grade" target="_self"></a>
							</dd>
							...
							<dd class="fore1_6" id="_MYJD_share">
								<a clstag="homepage|keycount|home2013|Homeshare"
									href="http://share.jd.com/share/index.html" target="_self"></a>
							</dd>
							...
							<dd class="fore1_8" id="_MYJD_recor">
								<a clstag="homepage|keycount|home2013|Homeedm"
									href="http://usergrade.jd.com/user/consume" target="_self"></a>
							</dd>
							<dd class="fore1_9" id="_MYJD_app">
								<a clstag="homepage|keycount|home2013|Homeedm"
									href="http://fw.jd.com/home/auth_list.action" target="_blank"></a>
							</dd>
				...
				<div id="main">
					<div class="mod-main mod-comm">
						...
						<div class="mc">
							...
							<div class="form">
								<div class="item">
									<span class="label">验证邮箱：</span><span><input
										class="itxt" type="text" id="emailinfo" name="emailinfo" /></span>
									<div class="fl">
										<strong id="mobileSpan" class="ftx-un"></strong>
										<div class="clr"></div>
								...
								<div class="item">
									<span class="label">请填写获取的邮箱校验码：</span>
									<div class="fl">
										<input class="itxt" name="identifyCode" tabindex="1" id="identifyCode"
											onchange="checkCode();" type="text" ></input> <a
											onclick="email()" , target="_blank" id="sendMobileCode"
											class="btn btn-10 ml10"><s></s>获取邮箱校验码</a>
										<div class="clr"></div>
										<div id="countDown" class="msg-text" style="display: none;">
											校验码已发出，请注意查收短信，如果没有收到，你可以在<strong class="ftx-01">60</strong>秒后要求系统重新发送
										</div>
										<div class="msg-error" id="sendCode_error"
								...
								<div class="item">
									<span class="label">&nbsp;</span> <input type="text"
										id="signedData" value="" style="display: none" /> <input
										type="text" id="serialNumber" value="" style="display: none" />
									<div class="fl">
										<a id="submitCode" class="btn btn-5"										
											onclick="identifyCode()" target="_blank">提交
											${error}
											</a>
									</div>
									<div class="clr"></div>
					...
					<div class="mod-main mod-comm">
						...
						<div class="mc">
							...
							<div>
								2. 验证身份遇到问题？请发送用户名、手机号、历史订单发票至<a class="ftx-05"
									href="javascript:void(0);">shensu@jd.com</a>，客服将尽快联系您。
							</div>
						</div>
					</div>
				</div>
			...
			<div id="footer-2014">
				...
				<div class="authentication">
					...
					<a rel="nofollow" target="_blank" id="urlknet" tabindex="-1"
						...
						href="http://jubao.china.cn:13225/reportform.do"> <img
						width="185" height="32"
		...
		<script type="text/javascript">
			...
			jQuery.ajax({
				type : "get",
				url : "/validate/mobile/getMobile.action?type=email",
				dataType : "text",
		...
		<script charset="utf-8" type="text/javascript"
			src="/js/certClient.js?t=20130913"></script>
		<script type="text/javascript">
			var dcmsg = "";
			var verifyString = encodeURI(encodeURI("验证邮箱"));
			if (dcmsg != "") {
				//判断是否安装控件
				if (!checkInstall()) {
					window.location.href = "http://safe.jd.com/validate/verify/validDc.action?verifyString="
							+ verifyString;
				}
				var resultArray = filterAndSign("", dcmsg);
				if (resultArray == "") {
					//引导安装证书页面
					window.location.href = "http://safe.jd.com/validate/verify/validDc.action?verifyString="
							+ verifyString;
				} else {
					$("#signedData").val(resultArray[1]);
					$("#serialNumber").val(resultArray[0]);
				}
			}
		</script>
